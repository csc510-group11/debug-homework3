...
from hw2_debugging import merge_sort_nafreen # fixed: wildcard-import
...
def test_merge_sort():
    ...
    if merge_sort_nafreen([]) != []:
        raise AssertionError("The output array is not sorted correctly.") # fixed: CWE-703
    # Test case 2: List with one element
    if merge_sort_nafreen([-9]) != [-9]:
        raise AssertionError("The output array is not sorted correctly.") # fixed: CWE-703
    # Test case 3: List with multiple elements
    if merge_sort_nafreen([3, 1, 4, 1, 5, 9, 2, 6, 5, 3, 5]) != [1, 1, 2, 3, 3, 4, 5, 5, 5, 6, 9]:
        raise AssertionError("The output array is not sorted correctly.") # fixed: CWE-703
